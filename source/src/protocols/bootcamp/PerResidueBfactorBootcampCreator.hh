...
/// @file protocols/bootcamp/PerResidueBfactorBootcampCreator.hh
/// @brief Simple Metric class for pLDDT value extraction from AF2
/// @author Jihun (jeung@uw.edu)

#ifndef INCLUDED_protocols_bootcamp_PerResidueBfactorBootcampCreator_HH
#define INCLUDED_protocols_bootcamp_PerResidueBfactorBootcampCreator_HH
...
class PerResidueBfactorBootcampCreator : public core::simple_metrics::SimpleMetricCreator {
public:
...
#endif //INCLUDED_protocols_bootcamp_PerResidueBfactorBootcampCreator_HH
