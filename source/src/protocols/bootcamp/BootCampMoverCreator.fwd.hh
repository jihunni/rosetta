...
class BootCampMoverCreator;

using BootCampMoverCreatorOP = utility::pointer::shared_ptr< BootCampMoverCreator >;
using BootCampMoverCreatorCOP = utility::pointer::shared_ptr< BootCampMoverCreator const >;
