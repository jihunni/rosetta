...
static basic::Tracer TR( "apps.pilot.jihun.bootcamp_FoldTree" );
...
int main( int argc, char ** argv) {
    ...
    core::pose::correctly_add_cutpoint_variants(*pose); // adding the cutpoint variants (virtual atom) to your Pose (upper and lower-cutpoint variants of each basic amino acid types)
    sfxn->set_weight( core::scoring::chainbreak, 1.0 ); // add the chainbreak term in scorefunction
